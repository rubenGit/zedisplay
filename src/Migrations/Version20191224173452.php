 ...
 */
final class Version20191224173452 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE content (id VARCHAR(255) NOT NULL, client_id VARCHAR(255) DEFAULT NULL, channel_id VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, url VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE channel (id VARCHAR(255) NOT NULL, client_id VARCHAR(255) DEFAULT NULL, device_id VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE client (id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, company_name VARCHAR(255) NOT NULL, tax_id VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, postal_code VARCHAR(255) NOT NULL, state VARCHAR(255) NOT NULL, country VARCHAR(2) NOT NULL, contact_person_name VARCHAR(255) NOT NULL, contact_person_phone VARCHAR(255) NOT NULL, contact_person_email VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
